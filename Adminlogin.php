            ...
            <!-- row -->
                ...
                <div class="login-marg">
                    ...
                    <!-- /Billing Details -->
                            ...
                            <form action="admin/index.php" id="Login" class="login100-form ">
                                ...
                                <div class="form-group">
                                   <label for="email"> Admin Email</label>
                                    <input class="input input-borders" type="email" name="email" placeholder=" AdminEmail" id="password" required>
                                </div>
                                ...
                                <div class="text-pad" >
                                   <a href="#">
                                    ...
                                    <input class="primary-btn btn-block"   Name="success" type="submit"  Value="Login">
