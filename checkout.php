	...
	<div class="container-fluid">
				...
				<form id="checkout_form" action="checkout_process.php" method="POST" class="was-validated">
					...
					<div class="col-50">
						...
						<div class="col-50">
							...
							<input type="text" id="state" name="state" value="gujarat" class="form-control" pattern="^[a-zA-Z ]+$" required>
						</div>
						<div class="col-50">
							<label for="zip">Zip</label>
							<input type="text" id="zip" name="zip" value="383450" class="form-control" pattern="^[0-9]{6}(?:-[0-9]{4})?$" required>
						</div>
						</div>
					</div>
		...
		?>
			...
			<div class="col-25">
				...
				<h3>Total<span class='price' style='color:black'><b>Rs :-".$_SESSION['total']="$total";$total."</b></span></h3>";
